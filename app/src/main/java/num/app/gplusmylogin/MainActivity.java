...
public class MainActivity extends AppCompatActivity implements OnConnectionFailedListener, View.OnClickListener, ConnectionCallbacks, ResultCallback<LoadPeopleResult> {
    ...
    */
    ...
    protected void onResume() {
        ...
        /* Checks if the client is currently connected to the service.Returns true if the client is connected to the service.*/
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.frnd_button:
                ...
                /*
                * The loadVisible method returns a list of people that are visible to the requesting app, which is the people who are in circles that the user has permitted the app to see.
                * */
    ...
    private void gPlusSignOut() {
        if (google_api_client.isConnected()) {
            Plus.AccountApi.clearDefaultAccount(google_api_client);
            //disconnect client to google pay services
            google_api_client.disconnect();
            google_api_client.connect();
            changeUI(false);
        }
    ...
    */
    ...
    public void onResult(LoadPeopleResult peopleData) {
        if (peopleData.getStatus().getStatusCode() == CommonStatusCodes.SUCCESS) {
            //The PersonBuffer offers a cursor-like interface for traversing through the collection of people
            ...
            try {
                ...
                //the PersonBuffer.release method when you are done loading data from the PersonBuffer.
